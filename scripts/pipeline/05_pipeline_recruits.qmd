...
quads$area_m2<-ifelse(quads$one == "two" & quads$quadrats == 6, 16*.25, quads$area)
quads$area_m2<-ifelse(quads$one == "one" & quads$quadrats == 10, 10*.25, quads$area_m2)

quads_dens<-quads[,c("ps_site_id","area_m2")]
