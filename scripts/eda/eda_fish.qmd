...
biomass_by_taxa_and_station <- read_csv(file.path(exp_path, "data/primary/output/fish/biomass_by_station_and_taxa.csv"))

stations <- read_csv(file.path(exp_path, "data/primary/output/fish/station_summary.csv"))

observations <- read_csv(file.path(exp_path, "data/primary/output/fish/biomass_per_obs.csv"))
