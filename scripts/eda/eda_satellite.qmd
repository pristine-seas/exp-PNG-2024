...
Loading the RData file that has the SST time series data of the mean monthly values for Solomons for each site from 2014-2025 along with the maximum monthly mean (MMM) values by region and subregion which were calculated from the Coral Reef Watch (CRW) climatological range of 1985-2012.
